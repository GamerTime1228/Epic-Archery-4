...
function handleComputerArrowCollision() {
  ...
  for (var i = 0; i < computerArrows.length; i++) {
    var baseCollision2 = Matter.SAT.collides(computerArrows[i].body, playerBase.body);
    var archerCollision2 = Matter.SAT.collides(computerArrows[i].body, playerArcher.body);
    var computerCollision2 = Matter.SAT.collides(computerArrows[i].body, player.body);

    if(baseCollision2.collided || archerCollision2.collided || computerCollision2.collided) {
